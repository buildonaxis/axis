...
import { createReceivingEvent, createShippingEvent, createPackingEvent, createUnpackingEvent, createCommissioningEvent, createDecommissioningEvent, createTransformationEvent, createShippingTransactionEvent, createReceivingTransactionEvent, createReturnEvent, createRecallEvent, createQualityHoldEvent, createReleaseEvent, createInventoryCountEvent, createInventoryAdjustmentEvent, } from "./events.js";
describe("event factories", () => {
    ...
    it("creates a transformation event", () => {
        const input = SerializedItem.fromBarcode("01000312345678901726123121INPUT123");
        const output = SerializedItem.fromBarcode("01000312345678901726123121OUTPUT123");
    ...
    it("creates a return event", () => {
        const item = SerializedItem.fromBarcode("010003123456789017261231ABC123");
