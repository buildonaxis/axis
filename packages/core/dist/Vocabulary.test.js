...
describe("Vocabulary", () => {
    it("creates vocabulary", () => {
        ...
        expect(vocabulary.type).toBe("urn:epcglobal:epcis:vtype:Location");
    });
    it("adds elements", () => {
        const vocabulary = new Vocabulary({
            type: "Location"
        });
        const updated = vocabulary.add(new VocabularyElement({
            id: "loc-1"
        }));
    ...
    it("finds elements", () => {
        ...
        expect(vocabulary.find("loc-1")).toBeDefined();
    });
});
